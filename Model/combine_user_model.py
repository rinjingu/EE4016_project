...
model.load_state_dict(torch.load(os.path.join(cwd, 'trained_model/collab_test1.pth')))
model = model.to(device)

combined_model = CombinedModel(transformer_model, model,df)
...
train_len = int(total_len * 0.001)
val_len = int(total_len * 0.0005)
